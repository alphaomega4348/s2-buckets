...
export default function StandardDashboard() {
    ...
    const tiles = [
        { icon: ecohublogo, iconSize: 80, title: 'EcoHub Dashboard', desc: 'Harness real-time sustainability insights, track carbon savings, and manage eco-friendly purchases',link:'/greendashboard' },
