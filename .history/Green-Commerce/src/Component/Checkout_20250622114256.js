...
export default function CheckoutProduct({
  ...
  stock = 5,
  originalPrice,
  discountPercent = originalPrice ? Math.round(100 - (price * 100) / originalPrice) : 0,
    ...
    <div style={{ display: "flex", gap: 20, alignItems: "flex-start", width: "100%" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 20, fontWeight: "bold", color: "#222", letterSpacing: ".03em" }}>
            ₹{price}
          </span>
          {originalPrice && (
            <span style={{ color: "#9e9e9e", textDecoration: "line-through", fontSize: 16 }}>
              ₹{originalPrice}
            </span>
          )}
          {!!discountPercent && (
        ...
        <div style={{
          ...
          <span style={{ color: "#222", fontSize: 15, fontWeight: 500 }}>
