  ...
  return (
    <div style={container}>
      ...
      <section style={hero}>
        ...
        <div style={textBlock}>
          <h2 style={{ ...sectionTitle, borderColor: "#d0e3de" }}>Carbon‑Free Energy</h2>
          <p>
            ...
            our commitment to The Climate Pledge to reach net‑zero carbon emissions by 2040.

            We are proud to have achieved this goal in 2023, seven years early, 
            with 100% of the electricity consumed by Amazon matched with renewableenergy sources
          </p>
        </div>
      </section>
