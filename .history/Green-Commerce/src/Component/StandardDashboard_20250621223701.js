...
export default function StandardDashboard() {
    ...
    const tiles = [
        ...
        { icon: 'https://lirp.cdn-website.com/7c70a9c0/dms3rep/multi/opt/EcoHub_Logo_Big_NoTag-1920w.png', title: 'EcoHub Dashboard', desc: 'Contact service via phone or chat' }
