...
export default function GreenProducts({ description, topN = 5 }) {
    ...
    const navItems = [
        { to: '/seller', label: 'Seller', back: '🤝' },
        { to: '/education', label: 'Education', back: '📚' },
        { to: '/reports', label: 'Reports', back: '📈' },
      ];
    const sidebar = {
        width: '240px',
            ...
            <div style={{
                ...
                <aside style={sidebar}>
                    ...
                    <div style={cardContainer}>
                        {navItems.map(({ to, label, back }, idx) => (
                            <div
                                key={to}
                                style={cardWrapper}
                            ...
                            >
                                <Link to={to} style={{ textDecoration: 'none' }}>
                                    <div style={cardInner(idx)}>
                                        <div style={frontFace}>{label}</div>
                                        <div style={backFace}>{back}</div>
                                    </div>
                                </Link>
                            </div>
                        ))}
                    ...
                    <div style={chipsWrap}>
                        {leftFilterDefs.map(f => {
                            ...
                            const isHover = hoveredChip === f.key;
                            return (
                                <div
                                    key={f.key}
                                    style={{
                    ...
                    <div style={quickWrap}>
                        {products.slice(0, 10).map(p => (
                            <img
                                ...
                                onMouseLeave={e => Object.assign(e.currentTarget.style, thumb)}
                            />
                        ))}
                    </div>
                </aside>
