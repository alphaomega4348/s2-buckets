                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        {visibleCats.map(cat => {
                            ...
                            const chipStyle = {
                                ...
                                padding: '0.6rem 1rem',
                                borderRadius: '20px',
                                border: isActive ? '2px solid #357a38' : '2px solid #888',
                                background: isActive
                                    ? '#4a8f4a'
                                    : isHover
                                        ? '#eaf6eb'
                                ...
                                transform: isHover && !isActive ? 'scale(1.02)' : 'scale(1)'
                            };
                    ...
                    {selectedCategory && (
                        <button
                            ...
                            onMouseLeave={e => {
                                ...
                                e.currentTarget.style.color = '#4a8f4a';
                            }}
