// Updated Home.js with inline styles for product cards
...
export default function Home() {
  ...
  const rowStyle = { display: 'flex', flexWrap: 'wrap', justifyContent: 'center', margin: '16px 0' };
  const cardStyle = {
    background: '#ffffff',
    borderRadius: '8px',
  ...
  const imageStyle = { maxWidth: '100%', height: 'auto', marginBottom: '12px' };
