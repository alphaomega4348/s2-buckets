...
export default function StandardDashboard() {
    ...
    const tiles = [
        ...
        { icon: 'o_Big_NoTag-1920w.png', title: 'EcoHub Dashboard', desc: 'Harness real-time sustainability insights, track carbon savings, and manage eco-friendly purchases' }
