...
export default function StandardDashboard() {
    ...
    const tiles = [
        { icon: '0a-3Z&sp=rb03c-d8867278172a&skoid=6-21T13%3A16%3A41Z&ske=2025-06-22T13%3A16%3A41Z&sks=b&skv=2024-08-04&sig=hkmQA19u82l4vFIrhTUF5czZBa4cl1JDbHx1lcaoDHA%3', title: 'EcoHub Dashboard', desc: 'Harness real-time sustainability insights, track carbon savings, and manage eco-friendly purchases',link:'/greendashboard' },
