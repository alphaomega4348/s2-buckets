    ...
    return (
        <div 
            style={{
                ...
                width: '100%',
                height: '100%',
                backgroundColor: 'rgba(0,0,0,0.7)',      // ← Change the “.5” here to 0.3 or 0.7 for lighter/darker dimming
                zIndex: 1000,
                display: 'flex',
                justifyContent: 'center',
                alignItems: 'center'
                        ...
                        {categories.map(cat => (
                            ...
                            >
                                <input
                                    ...
                                    style={{ marginRight: '0.5rem', accentColor: '#2E7D32' }}
                                />
