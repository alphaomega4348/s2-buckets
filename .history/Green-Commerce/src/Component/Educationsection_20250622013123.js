...
export default function EducationSection() {
  ...
  const handleNavClick = (e, id) => {
    ...
    // Element’s distance from top of the page
    ...
    // Calculate scroll position so element’s center lands in viewport center
    const scrollTo =
      elTop - (viewportHeight / 2 - elHeight / 2);

    window.scrollTo({
      top: scrollTo < 0 ? 0 : scrollTo, // avoid negative
      behavior: "smooth",
    });
  };
