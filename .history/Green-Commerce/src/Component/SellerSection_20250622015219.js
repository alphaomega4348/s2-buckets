...
export default function SellerSection() {
  ...
  const handleChange = (e) => {
    ...
    if (name.startsWith("filters.")) {
      ...
      setFormData((prev) => ({
        ...prev,
        filters: { ...prev.filters, [key]: checked },
      }));
    } else if (type === "file") {
  ...
  const calculateGrade = async (e) => {
    ...
    try {
      ...
      setFormData((prev) => ({ ...prev, grade: predicted_grade }));
  ...
  const handleSubmit = async (e) => {
    ...
    for (let [key, val] of Object.entries(formData)) {
      ...
      if (val === "" || val == null) {
        return showToast(`Please fill in ${key}`, "error");
      }
    }
  ...
  // ---- Styles (matching EducationSection) ----
  const container = {
    maxWidth: 960,
    margin: "40px auto",
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <div style={grid2}>
            <div>
              <label style={labelStyle}>
                % less plastic vs. standard competitor
              </label>
              <input
                type="number"
            ...
            <div>
              <label style={labelStyle}>
                % of synthetic chemicals vs. natural
              </label>
              <input
                type="number"
            ...
            <div>
              <label style={labelStyle}>
                Recyclable material? (1 = Yes, 0 = No)
              </label>
              <select
                name="isRecyclable"
            ...
            <div>
              <label style={labelStyle}>
                Packaging fully recyclable? (1 = Yes, 0 = No)
              </label>
              <select
            ...
            <div>
              <label style={labelStyle}>
                % biodegradable ingredients/materials
              </label>
              <input
                type="number"
      ...
      {modalGrade && (
        <div style={modalBackdrop}>
          <div style={modalBox}>
            ...
            <h3 style={{ margin: "0 0 16px", fontSize: 22, color: "#01332b" }}>
              Your Eco Rating
            </h3>
