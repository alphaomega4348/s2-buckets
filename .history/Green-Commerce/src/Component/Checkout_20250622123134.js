...
function Checkout() {
  ...
  const [selectedItems, setSelectedItems] = useState(
    basket.reduce((acc, _, idx) => ({ ...acc, [id]: true }), {})
  );
              ...
              <div>
                ...
                <div style={styles.summaryRow}>
                  ...
                  <span style={{ color: "#48BB78" }}>
                    -₹{basket.reduce(
                      (sum, item) =>
                        sum + ((Number(item.price) || 0) * (Number(item.discountPercent) || 0)) / 100,
                      0
                    )}
                  </span>
                </div>
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: 15, marginTop: 6 }}>
                ...
                <button
                  onClick={() => {
                    // Save logic: You can combine address fields as needed
