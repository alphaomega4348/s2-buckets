...
export default function SuggestGreenBrands() {
    ...
    return (
        <div style={section}>
            <h2 style={{ ...header, fontSize: 24 }}>Featuring eco-conscious companies making real impact—discover brands championing sustainability</h2>
            <p style={{ ...header, fontSize: 16 }}>Learn more about our 5 Pillars of sustainable product sourcing.</p>
