    ...
    const brands = [
        ...
        { 
            name: 'Plaine Products',
             image: 'https://example.com/plaine.png', description: 'Plaine Products provides refillable personal care essentials in aluminum bottles to eliminate single-use plastics.'
         },
        {
