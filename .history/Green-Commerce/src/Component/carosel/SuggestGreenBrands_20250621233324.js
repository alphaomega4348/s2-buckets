...
export default function SuggestGreenBrands() {
    const brands = [
         ...
         },
        {
             ...
             image: 'https://example.com/holylamb.png', description: 'Holy Lamb Organics delivers certified organic wool products that are sustainable, cozy, and hypoallergenic.' 
        },
        { 
