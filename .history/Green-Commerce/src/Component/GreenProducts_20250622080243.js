        ...
        <div>
            ...
            <div style={{
                ...
                <aside
                    style={{
                        width: '220px',
                        backgroundColor: '#ebf6eb',   // match left‐sidebar tone
                        borderRadius: '12px',
                        padding: '1rem',
                        boxShadow: expanded
                            ? '0 0 20px rgba(74,143,74,0.7)'
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        {categories.length > 10 && (
                            <div
                                ...
                                onMouseLeave={() => {
                                    // collapse if nothing is selected
                                    if (!selectedCategory) setExpanded(false);
                                }}
                                onClick={() => {
                                    if (expanded) {
                                        // second click: clear filter + collapse
                                        setSelectedCategory(null);
                                        setExpanded(false);
                                    } else {
                                        // first click: simply expand
                                        setExpanded(true);
                                    }
                                }}
                            >
                                {expanded
                                    ? 'Collapse & Clear Filters ▲'
                                    : 'See more categories ▼'}
                            </div>
                        )}
                    </div>
