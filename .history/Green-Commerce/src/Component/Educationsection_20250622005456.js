...
// Data for the animated progress chart
const progressData = [
  { year: "2019", value: 42 },
  { year: "2020", value: 65 },
  { year: "2021", value: 85 },
...
export default function EducationSection() {
  ...
  return (
    <div style={container}>
      ...
      <section style={hero}>
        <div style={textBlock}>
          ...
          <p>
            ...
            required to avoid the most severe effects of climate change,
            restore biodiversity, protect vulnerable communities, and ensure a
            habitable planet for future generations. Amazon has an incredibly
            ambitious goal to achieve net-zero carbon across our operations by
            2040. We’ll do this by implementing decarbonization strategies
            through real business changes and innovations, and neutralizing any
            remaining emissions with additional, quantifiable, real, permanent,
            and socially beneficial offsets to achieve net-zero annual carbon
            emissions by 2040.
          </p>
        </div>
      ...
      {/* Tutorial Section with Animated Graph */}
      <section style={hero}>
        <div style={graphBlock}>
        ...
        <div style={textBlock}>
          <h2 style={{ ...sectionTitle, borderColor: "#d0e3de" }}>
            Carbon-Free Energy
          </h2>
          <p>
            Transitioning to carbon-free energy sources—which include
            renewable energy sources such as wind and solar as well as other
            sources such as nuclear power—is one of the most effective ways to
            lower Scope 2 emissions. By scaling carbon-free energy, we aim to
            make Amazon a more resilient and more sustainable business, drive a
            global transition to cleaner energy, and achieve our commitment to
            The Climate Pledge to reach net-zero carbon emissions by 2040.
          </p>
          <p>
            We are proud to have achieved this goal in 2023, seven years early,
            with 100% of the electricity consumed by Amazon matched with
