...
const styles = {
  ...
  // ...keep all your style definitions as before...
};
...
function Checkout() {
  ...
  const [savedAddress, setSavedAddress] = useState(null); // for showing in sidebar
  ...
  // ---------- JSX RETURN BELOW -----------
  return (
    <div style={{ background: "linear-gradient(120deg, #f8fbf9 70%, #f3f9f4 100%)" }}>
          ...
          <div style={styles.sidebar}>
            ...
            >
              ...
              {savedAddress ? (
                ...
                >
                  <div><b>Home/Flat:</b> {savedAddress.homeNo || "-"}</div>
                  <div><b>Pincode:</b> {savedAddress.pincode || "-"}</div>
        ...
        {showAddressModal && (
          ...
          >
            ...
            >
              ...
              />
              <div style={{ display: "flex", justifyContent: "flex-end", gap: 15, marginTop: 6 }}>
                <button
                ...
                <button
                  onClick={() => {
                    setSavedAddress({ homeNo, pincode, address });
