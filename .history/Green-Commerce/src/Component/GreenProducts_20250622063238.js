    ...
    return (
        <div>
            ...
            <div style={{
                ...
                {/* RIGHT BAR: category selector as hover menu */}
                <aside
                    className="category-hover-menu"
                    style={{
                        position: 'relative',
                        width: '48px',
                        padding: '1rem',
                ...
                >
                    {/* three-bar icon */}
                    <FiMenu size={24} color="green" style={{ cursor: 'pointer' }} />
                    ...
                    <div
                        ...
                        style={{
                            display: 'none',
                            position: 'absolute',
                            right: '100%',   // drop to the left of icon
                            top: 0,
                            backgroundColor: '#fff',
                            borderRadius: '8px',
                    ...
                    >
                        <h4 style={{ margin: '0 0 0.5rem' }}>Categories</h4>
                        {categories.map(cat => (
                            <label key={cat} style={{ display: 'block', fontSize: '0.9rem', margin: '0.25rem 0' }}>
                                <input
                                    type="radio"
                                    name="category"
