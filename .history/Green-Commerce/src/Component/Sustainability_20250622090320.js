    ...
    <div style={{
      ...
      <div style={{
        ...
        {[
          {
            title: "Overview",
            text: `Sustainability reports for eco-friendly products serve as a communication tool,
      helping consumers and stakeholders understand the efforts a company makes to minimize its environmental
      and social impact. They also allow for greater accountability and transparency in the growing market
      for sustainable and environmentally conscious products.`
          },
          {
            title: "Reports & Downloads",
            text: `Amazon’s 2022 Sustainability Report reflects the continuation
      of our sustainability efforts, which have been ongoing for the past decade.
      Amazon regularly publishes sustainability reports to communicate its
      environmental and social impact and its efforts to become more sustainable.`
          }
        ].map((panel, i) => (
          <div
            key={i}
